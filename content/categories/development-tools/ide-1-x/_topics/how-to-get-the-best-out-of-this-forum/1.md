...
Code should be be in code tags, which can be added by clicking the **`<CODE/>`** icon on the tool bar at the bottom of the post composer panel. This will cause the code to be displayed in a code block, like this:
